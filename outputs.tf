output "cosmosdb_gremlin_databases_id" {
  ...
  value       = { for k, v in azurerm_cosmosdb_gremlin_database.cosmosdb_gremlin_databases : k => v.id if v.id != null && length(v.id) > 0 }
}
output "cosmosdb_gremlin_databases_account_name" {
  ...
  value       = { for k, v in azurerm_cosmosdb_gremlin_database.cosmosdb_gremlin_databases : k => v.account_name if v.account_name != null && length(v.account_name) > 0 }
}
output "cosmosdb_gremlin_databases_autoscale_settings" {
  ...
  value       = { for k, v in azurerm_cosmosdb_gremlin_database.cosmosdb_gremlin_databases : k => v.autoscale_settings if v.autoscale_settings != null && length(v.autoscale_settings) > 0 }
}
output "cosmosdb_gremlin_databases_name" {
  ...
  value       = { for k, v in azurerm_cosmosdb_gremlin_database.cosmosdb_gremlin_databases : k => v.name if v.name != null && length(v.name) > 0 }
}
output "cosmosdb_gremlin_databases_resource_group_name" {
  ...
  value       = { for k, v in azurerm_cosmosdb_gremlin_database.cosmosdb_gremlin_databases : k => v.resource_group_name if v.resource_group_name != null && length(v.resource_group_name) > 0 }
}
output "cosmosdb_gremlin_databases_throughput" {
  ...
  value       = { for k, v in azurerm_cosmosdb_gremlin_database.cosmosdb_gremlin_databases : k => v.throughput if v.throughput != null }
}
